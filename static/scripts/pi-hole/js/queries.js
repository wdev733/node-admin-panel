...
function refreshData() {
    tableApi.ajax.url("/api/data?getAllQueries").load();
//    updateSessionTimer();
}
...
function add(row) {
    ...
    $.ajax({
        ...
        method: "post",
        data: {"domain":rowData.domain, "list":list, "token":token},
...
$(document).ready(function() {
    ...
    tableApi = $("#all-queries").DataTable( {
        ...
        "order" : [[0, "desc"]],
        "columns": [
            { "width" : "20%", "data":"time", "type": "date" },
            { "width" : "10%", "data":"type" },
            { "width" : "40%", "data":"domain" },
            { "width" : "10%", "data":"client" },
